...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep  3 00:21:37 2018
...
filenames = os.listdir('/Users/kewang/CS294HW/homework/hw1/Results_Nonlinear_Ant_dagger/')
...
for filename in filenames:
    if filename[0:7] == 'dagger_':
        ...
        print(num_echos)
        list_raw = list(pd.read_csv('/Users/kewang/CS294HW/homework/hw1/Results_Nonlinear_Ant_dagger/'+filename))[0:-2]
        data_raw = []
