...
def main():
    ...
    batch_size = 20
    num_epochs = [1,5,10,50,100,500,1000,2000,5000,10000,20000,50000]
    ...
    with tf.Session() as sess:
        ...
        for num_epoch in num_epochs:
            ...
            csvFile = open('teste_'+args.envname+'_'+str(num_epoch)+'_expert.csv','w', newline='')
            ...
            csvFile1 = open('testo_'+args.envname+'_'+str(num_epoch)+'_expert.csv','w', newline='')
