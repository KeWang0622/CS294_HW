...
def bcnet(outc, obs):
    fc1 = tf.tanh(tf.layers.dense(obs, 64))
    fc2 = tf.tanh(tf.layers.dense(fc1, 32))
    fc3 = tf.tanh(tf.layers.dense(fc2, 32))
...
def main():
    ...
    with tf.Session() as sess:
        ...
        for num_epoch in num_epochs:
            ...
            csvFile = open('nonle_'+args.envname+'_'+str(num_epoch)+'_expert_5.csv','w', newline='')
            ...
            csvFile1 = open('nonlo_'+args.envname+'_'+str(num_epoch)+'_expert_5.csv','w', newline='')
