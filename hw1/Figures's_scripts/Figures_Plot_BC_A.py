...
filenames = os.listdir('/Users/kewang/CS294HW/homework/hw1/Results_Behavior_Cloning_Ant')
...
for filename in filenames:
    if filename[0:5] == 'testo':
        print(filename)
        num_echos = int(filename[13:-11])
        print(num_echos)
        list_raw = list(pd.read_csv('/Users/kewang/CS294HW/homework/hw1/Results_Behavior_Cloning_Ant/'+filename))[0:-2]
        data_raw = []
