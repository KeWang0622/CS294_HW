...
filenames = os.listdir('/Users/kewang/CS294HW/homework/hw1/Results_Dagger_Ant')
...
for filename in filenames:
    if filename[0:7] == 'dagger_':
        print(filename)
        num_echos = int(filename[14:-11])
        print(num_echos)
        list_raw = list(pd.read_csv('/Users/kewang/CS294HW/homework/hw1/Results_Dagger_Ant/'+filename))[0:-2]
        data_raw = []
